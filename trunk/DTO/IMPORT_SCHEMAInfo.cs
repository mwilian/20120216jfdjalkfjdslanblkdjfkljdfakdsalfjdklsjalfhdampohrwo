...
namespace DTO
{
    ...
    public class IMPORT_SCHEMAInfo
    {
		...
		public IMPORT_SCHEMAInfo(DataRow dr)
		{
			if (dr != null)
			{
		...
		public IMPORT_SCHEMAInfo(IMPORT_SCHEMAInfo objEntr)
		{			
		...
		{
			DataTable dt = new DataTable("IMPORT_SCHEMA");
