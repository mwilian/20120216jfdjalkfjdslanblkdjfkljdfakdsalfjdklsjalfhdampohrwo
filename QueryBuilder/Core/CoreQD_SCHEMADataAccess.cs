    ...
    public class CoreQD_SCHEMADataAccess : CoreConnection
    {
        ...
        ref string sErr)
        {
            ...
            try
            {
                ...
                AddParameter(prefix + CoreQD_SCHEMAInfo.Field.CONN_ID.ToString(), CONN_ID);
                AddParameter(prefix + CoreQD_SCHEMAInfo.Field.SCHEMA_ID.ToString(), SCHEMA_ID);
        ...
        public Int32 Add(CoreQD_SCHEMAInfo objEntr, ref string sErr)
        {
            int ret = -1; try
            {
                ...
                AddParameter(prefix + CoreQD_SCHEMAInfo.Field.CONN_ID.ToString(), objEntr.CONN_ID);
                AddParameter(prefix + CoreQD_SCHEMAInfo.Field.SCHEMA_ID.ToString(), objEntr.SCHEMA_ID);
                AddParameter(prefix + CoreQD_SCHEMAInfo.Field.LOOK_UP.ToString(), objEntr.LOOK_UP);
                AddParameter(prefix + CoreQD_SCHEMAInfo.Field.DESCRIPTN.ToString(), objEntr.DESCRIPTN);
                AddParameter(prefix + CoreQD_SCHEMAInfo.Field.FIELD_TEXT.ToString(), objEntr.FIELD_TEXT);
                AddParameter(prefix + CoreQD_SCHEMAInfo.Field.FROM_TEXT.ToString(), objEntr.FROM_TEXT);
                AddParameter(prefix + CoreQD_SCHEMAInfo.Field.DAG.ToString(), objEntr.DAG);
                AddParameter(prefix + CoreQD_SCHEMAInfo.Field.SCHEMA_STATUS.ToString(), objEntr.SCHEMA_STATUS);
                AddParameter(prefix + CoreQD_SCHEMAInfo.Field.UPDATED.ToString(), objEntr.UPDATED);
                AddParameter(prefix + CoreQD_SCHEMAInfo.Field.ENTER_BY.ToString(), objEntr.ENTER_BY);
                AddParameter(prefix + CoreQD_SCHEMAInfo.Field.DEFAULT_CONN.ToString(), objEntr.DEFAULT_CONN);
