...
namespace QueryBuilder
{
    ...
    public class CoreQDD_FILTERInfo
    {
		...
		public CoreQDD_FILTERInfo(DataRow dr)
		{
			if (dr != null)
			{
		...
		public CoreQDD_FILTERInfo(CoreQDD_FILTERInfo objEntr)
		{			
			_DTB = objEntr.DTB;			
		...
		{
			DataTable dt = new DataTable("CoreQDD_FILTER");
