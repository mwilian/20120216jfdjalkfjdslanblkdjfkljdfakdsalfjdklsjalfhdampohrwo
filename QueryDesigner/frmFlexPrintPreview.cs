...
namespace QueryDesigner
{
    ...
    public partial class frmFlexPrintPreview : System.Windows.Forms.Form
    {
        ...
        public frmFlexPrintPreview(ExcelFile Xls)
        {
            InitializeComponent();
            cbInterpolation.SelectedIndex = 1;
            flexCelPrintDocument1.Workbook = Xls;
        }
        ...
        #region Export as images

        private void export_Click(object sender, System.EventArgs e)
        {
            exportImagesMenu.Show(sender as Control, new Point(0, (sender as Control).Height));
        }

        #region Export using Print Controller
        ...
        private void ExportUsingPrintController_Click(object sender, System.EventArgs e)
        {
            DoExportUsingPrintController();
        }
